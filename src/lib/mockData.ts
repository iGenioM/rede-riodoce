...
const PRODUCT_SEEDS: ProductSeed[] = [
  ...
  { id: "p_alface", producerId: "prod_boaesperanca", categoryId: "verduras", name: "Alface Crespa", description: "Pé fresquinho, colhido no dia. Ideal para saladas. Venda em caixa de atacado.", pricePerUnit: 63, unit: "cx", availableQty: 7, imageSeed: img("🥬", "#2f6b3f", "#8fc94a", FOOD_PHOTOS.alface), organic: true, harvestedAt: "2026-09-16", soldTotal: 27 },
  { id: "p_couve", producerId: "prod_boaesperanca", categoryId: "verduras", name: "Couve Manteiga", description: "Maço grande, folhas firmes e escuras. Venda em caixa de atacado.", pricePerUnit: 70, unit: "cx", availableQty: 6, imageSeed: img("🥬", "#1a4d32", "#5c9c6b", FOOD_PHOTOS.couve), organic: true, harvestedAt: "2026-09-16", soldTotal: 20 },
  { id: "p_rucula", producerId: "prod_boaesperanca", categoryId: "verduras", name: "Rúcula", description: "Sabor picante suave, ótima com azeite e parmesão. Venda em caixa de atacado.", pricePerUnit: 84, unit: "cx", availableQty: 6, imageSeed: img("🌱", "#2f6b3f", "#8fc94a", FOOD_PHOTOS.rucula), organic: true, harvestedAt: "2026-09-17", soldTotal: 10 },
  { id: "p_espinafre", producerId: "prod_boaesperanca", categoryId: "verduras", name: "Espinafre", description: "Rico em ferro, ótimo para sucos verdes. Venda em caixa de atacado.", pricePerUnit: 91, unit: "cx", availableQty: 6, imageSeed: img("🥬", "#1a4d32", "#8fc94a", FOOD_PHOTOS.espinafre), organic: true, harvestedAt: "2026-09-15", soldTotal: 6 },
  { id: "p_brocolis", producerId: "prod_boaesperanca", categoryId: "verduras", name: "Brócolis Ninja", description: "Cabeças firmes e bem verdes, direto do pé. Venda em caixa de atacado.", pricePerUnit: 178, unit: "cx", availableQty: 6, imageSeed: img("🥦", "#1a4d32", "#5c9c6b", FOOD_PHOTOS.brocolis), organic: true, harvestedAt: "2026-09-16", soldTotal: 9 },

  // Raízes do Vale — tubérculos
  { id: "p_batata", producerId: "prod_raizesdovale", categoryId: "raizes", name: "Batata Asterix", description: "Casca rosada, ótima para fritar ou assar. Saco padrão de atacado (25–60 kg).", pricePerUnit: 150, unit: "saco", availableQty: 6, imageSeed: img("🥔", "#8a5a34", "#c98f56", FOOD_PHOTOS.batata), organic: false, harvestedAt: "2026-09-12", soldTotal: 59 },
  { id: "p_mandioca", producerId: "prod_raizesdovale", categoryId: "raizes", name: "Mandioca Descascada", description: "Já descascada e lavada, pronta pra cozinhar. Saco padrão de atacado (25–60 kg).", pricePerUnit: 165, unit: "saco", availableQty: 3, imageSeed: img("🍠", "#8a5a34", "#c98f56", FOOD_PHOTOS.mandioca), organic: false, harvestedAt: "2026-09-14", soldTotal: 21 },
  { id: "p_cenoura", producerId: "prod_raizesdovale", categoryId: "raizes", name: "Cenoura", description: "Doce e crocante, colhida sob encomenda. Saco padrão de atacado (25–60 kg).", pricePerUnit: 130, unit: "saco", availableQty: 4, imageSeed: img("🥕", "#d9762b", "#f2b134", FOOD_PHOTOS.cenoura), organic: true, harvestedAt: "2026-09-15", soldTotal: 30 },
  { id: "p_beterraba", producerId: "prod_raizesdovale", categoryId: "raizes", name: "Beterraba", description: "Ótima para saladas e sucos detox. Saco padrão de atacado (25–60 kg).", pricePerUnit: 136, unit: "saco", availableQty: 3, imageSeed: img("🍠", "#c93a4e", "#f2708a", FOOD_PHOTOS.beterraba), organic: true, harvestedAt: "2026-09-13", soldTotal: 14 },
  { id: "p_inhame", producerId: "prod_raizesdovale", categoryId: "raizes", name: "Inhame", description: "Textura cremosa, ótimo em sopas e purês. Saco padrão de atacado (25–60 kg).", pricePerUnit: 196, unit: "saco", availableQty: 3, imageSeed: img("🍠", "#8a5a34", "#c98f56", FOOD_PHOTOS.inhame), organic: false, harvestedAt: "2026-09-11", soldTotal: 7 },

  // Pomar Vermelho — frutas
  { id: "p_banana", producerId: "prod_pomarvermelho", categoryId: "frutas", name: "Banana Prata", description: "Cacho maduro no ponto, doce e macia. Venda em caixa de atacado.", pricePerUnit: 76, unit: "cx", availableQty: 25, imageSeed: img("🍌", "#e0b84a", "#f2b134", FOOD_PHOTOS.banana), organic: false, harvestedAt: "2026-09-15", soldTotal: 83 },
  { id: "p_mamao", producerId: "prod_pomarvermelho", categoryId: "frutas", name: "Mamão Formosa", description: "Polpa alaranjada, super doce. Venda em caixa de atacado.", pricePerUnit: 99, unit: "cx", availableQty: 10, imageSeed: img("🥭", "#f2708a", "#f2b134", FOOD_PHOTOS.mamao), organic: false, harvestedAt: "2026-09-16", soldTotal: 37 },
  { id: "p_manga", producerId: "prod_pomarvermelho", categoryId: "frutas", name: "Manga Palmer", description: "Fruta grande, fibra macia, aroma marcante. Venda em caixa de atacado.", pricePerUnit: 124, unit: "cx", availableQty: 8, imageSeed: img("🥭", "#c93a4e", "#f2b134", FOOD_PHOTOS.manga), organic: false, harvestedAt: "2026-09-14", soldTotal: 27 },
  { id: "p_abacaxi", producerId: "prod_pomarvermelho", categoryId: "frutas", name: "Abacaxi Pérola", description: "Bem doce, pouco ácido, casca amarelada. Venda em caixa de atacado.", pricePerUnit: 98, unit: "cx", availableQty: 6, imageSeed: img("🍍", "#e0b84a", "#f2b134", FOOD_PHOTOS.abacaxi), organic: false, harvestedAt: "2026-09-13", soldTotal: 16 },
  { id: "p_limao", producerId: "prod_pomarvermelho", categoryId: "frutas", name: "Limão Taiti", description: "Suculento, ideal para sucos e temperos. Venda em caixa de atacado.", pricePerUnit: 70, unit: "cx", availableQty: 15, imageSeed: img("🍋", "#8fc94a", "#d3f08a", FOOD_PHOTOS.limao), organic: false, harvestedAt: "2026-09-16", soldTotal: 45 },

  // Vista Alegre — legumes
  { id: "p_tomate", producerId: "prod_vistaalegre", categoryId: "legumes", name: "Tomate Salada", description: "Vermelho, firme, ótimo pra salada e molho. Venda em caixa de atacado.", pricePerUnit: 142, unit: "cx", availableQty: 18, imageSeed: img("🍅", "#c93a4e", "#f2708a", FOOD_PHOTOS.tomate), organic: false, harvestedAt: "2026-09-16", soldTotal: 65 },
  { id: "p_pimentao", producerId: "prod_vistaalegre", categoryId: "legumes", name: "Pimentão Tricolor", description: "Mix verde, amarelo e vermelho, recém colhido. Venda em caixa de atacado.", pricePerUnit: 171, unit: "cx", availableQty: 7, imageSeed: img("🫑", "#8fc94a", "#f2b134", FOOD_PHOTOS.pimentao), organic: false, harvestedAt: "2026-09-15", soldTotal: 21 },
  { id: "p_abobrinha", producerId: "prod_vistaalegre", categoryId: "legumes", name: "Abobrinha Italiana", description: "Casca fina e macia, ótima para refogados. Venda em caixa de atacado.", pricePerUnit: 97, unit: "cx", availableQty: 9, imageSeed: img("🥒", "#2f6b3f", "#8fc94a", FOOD_PHOTOS.abobrinha), organic: true, harvestedAt: "2026-09-16", soldTotal: 13 },
  { id: "p_chuchu", producerId: "prod_vistaalegre", categoryId: "legumes", name: "Chuchu", description: "Clássico e versátil, direto do pé. Venda em caixa de atacado.", pricePerUnit: 72, unit: "cx", availableQty: 12, imageSeed: img("🥒", "#8fc94a", "#d3f08a", FOOD_PHOTOS.chuchu), organic: false, harvestedAt: "2026-09-14", soldTotal: 18 },
  { id: "p_pepino", producerId: "prod_vistaalegre", categoryId: "legumes", name: "Pepino Japonês", description: "Crocante, sem amargor, sem cera. Venda em caixa de atacado.", pricePerUnit: 108, unit: "cx", availableQty: 8, imageSeed: img("🥒", "#2f6b3f", "#5c9c6b", FOOD_PHOTOS.pepino), organic: true, harvestedAt: "2026-09-15", soldTotal: 10 },

  // Grãos do Cerrado
  { id: "p_feijao", producerId: "prod_graoscerrado", categoryId: "graos", name: "Feijão Carioca Novo", description: "Safra nova, cozinha rápido e rende bem. Saco padrão de atacado (25–60 kg).", pricePerUnit: 216, unit: "saco", availableQty: 7, imageSeed: img("🫘", "#b8892b", "#e8c565", FOOD_PHOTOS.feijao), organic: false, harvestedAt: "2026-08-30", soldTotal: 48 },
  { id: "p_milho", producerId: "prod_graoscerrado", categoryId: "graos", name: "Milho Verde", description: "Espiga doce, ótima pra pamonha e curau. Fardo para revenda.", pricePerUnit: 100, unit: "fardo", availableQty: 8, imageSeed: img("🌽", "#e8c565", "#f2b134", FOOD_PHOTOS.milho), organic: false, harvestedAt: "2026-09-10", soldTotal: 59 },
  { id: "p_arroz", producerId: "prod_graoscerrado", categoryId: "graos", name: "Arroz Agulhinha", description: "Grãos soltinhos, beneficiado artesanalmente. Saco padrão de atacado (25–60 kg).", pricePerUnit: 187, unit: "saco", availableQty: 5, imageSeed: img("🌾", "#b8892b", "#e8c565", FOOD_PHOTOS.arroz), organic: false, harvestedAt: "2026-08-20", soldTotal: 23 },
  { id: "p_cafe", producerId: "prod_graoscerrado", categoryId: "graos", name: "Café Torrado de Terreiro", description: "Torra média, moído na hora do pedido. Saco padrão de atacado (25–60 kg).", pricePerUnit: 616, unit: "saco", availableQty: 3, imageSeed: img("☕", "#6b4423", "#b8892b", FOOD_PHOTOS.cafe), organic: true, harvestedAt: "2026-09-01", soldTotal: 7 },

  // Canto do Galo — ovos e laticínios
  { id: "p_ovos", producerId: "prod_cantodogalo", categoryId: "laticinios", name: "Ovos Caipira", description: "Dúzia, galinhas soltas no pasto. Venda em caixa de atacado.", pricePerUnit: 392, unit: "cx", availableQty: 6, imageSeed: img("🥚", "#e0b84a", "#f7e29b", FOOD_PHOTOS.ovos), organic: false, harvestedAt: "2026-09-17", soldTotal: 43 },
  { id: "p_queijo", producerId: "prod_cantodogalo", categoryId: "laticinios", name: "Queijo Minas Artesanal", description: "Peça de 500g, curado 15 dias. Venda em caixa de atacado.", pricePerUnit: 448, unit: "cx", availableQty: 6, imageSeed: img("🧀", "#f7e29b", "#f2b134", FOOD_PHOTOS.queijo), organic: false, harvestedAt: "2026-09-10", soldTotal: 13 },
  { id: "p_requeijao", producerId: "prod_cantodogalo", categoryId: "laticinios", name: "Requeijão Cremoso", description: "Pote de 300g, receita da família. Venda em caixa de atacado.", pricePerUnit: 224, unit: "cx", availableQty: 6, imageSeed: img("🧈", "#f7e29b", "#e0b84a", FOOD_PHOTOS.requeijao), organic: false, harvestedAt: "2026-09-12", soldTotal: 10 },
  { id: "p_manteiga", producerId: "prod_cantodogalo", categoryId: "laticinios", name: "Manteiga Artesanal", description: "Pote de 200g, feita com nata fresca. Venda em caixa de atacado.", pricePerUnit: 259, unit: "cx", availableQty: 6, imageSeed: img("🧈", "#e0b84a", "#f2b134", FOOD_PHOTOS.manteiga), organic: false, harvestedAt: "2026-09-11", soldTotal: 5 },

  // Horta da Serra — temperos
  { id: "p_manjericao", producerId: "prod_hortadaserra", categoryId: "temperos", name: "Manjericão", description: "Folhas grandes e aromáticas, colhidas na hora. Venda em caixa de atacado.", pricePerUnit: 56, unit: "cx", availableQty: 6, imageSeed: img("🌿", "#1a4d32", "#5c9c6b", FOOD_PHOTOS.manjericao), organic: true, harvestedAt: "2026-09-17", soldTotal: 6 },
  { id: "p_salsinha", producerId: "prod_hortadaserra", categoryId: "temperos", name: "Salsinha", description: "Fresquinha, clássica pra temperar tudo. Venda em caixa de atacado.", pricePerUnit: 42, unit: "cx", availableQty: 6, imageSeed: img("🌿", "#2f6b3f", "#8fc94a", FOOD_PHOTOS.salsinha), organic: true, harvestedAt: "2026-09-17", soldTotal: 7 },
  { id: "p_cebolinha", producerId: "prod_hortadaserra", categoryId: "temperos", name: "Cebolinha", description: "Talos firmes e verdes. Venda em caixa de atacado.", pricePerUnit: 42, unit: "cx", availableQty: 6, imageSeed: img("🌿", "#1a4d32", "#8fc94a", FOOD_PHOTOS.cebolinha), organic: true, harvestedAt: "2026-09-17", soldTotal: 6 },
  { id: "p_hortela", producerId: "prod_hortadaserra", categoryId: "temperos", name: "Hortelã", description: "Aroma intenso, ótima pro suco e chá. Venda em caixa de atacado.", pricePerUnit: 49, unit: "cx", availableQty: 6, imageSeed: img("🌿", "#5c9c6b", "#d3f08a", FOOD_PHOTOS.hortela), organic: true, harvestedAt: "2026-09-16", soldTotal: 4 },

  // Doces da Roça — processados
  { id: "p_geleia", producerId: "prod_docesdaroca", categoryId: "processados", name: "Geleia de Goiaba", description: "Pote de 250g, fruta da região. Engradado com múltiplas unidades.", pricePerUnit: 120, unit: "engradado", availableQty: 7, imageSeed: img("🍯", "#c93a4e", "#f2708a", FOOD_PHOTOS.geleia), organic: false, harvestedAt: "2026-09-05", soldTotal: 9 },
  { id: "p_docedeleite", producerId: "prod_docesdaroca", categoryId: "processados", name: "Doce de Leite Cremoso", description: "Pote de 300g, receita de tacho de cobre. Engradado com múltiplas unidades.", pricePerUnit: 144, unit: "engradado", availableQty: 6, imageSeed: img("🍮", "#e0b84a", "#c98f56", FOOD_PHOTOS.docedeleite), organic: false, harvestedAt: "2026-09-08", soldTotal: 10 },
  { id: "p_mel", producerId: "prod_docesdaroca", categoryId: "processados", name: "Mel Silvestre", description: "Vidro de 500g, das colmeias da propriedade. Engradado com múltiplas unidades.", pricePerUnit: 240, unit: "engradado", availableQty: 5, imageSeed: img("🍯", "#e0b84a", "#f2b134", FOOD_PHOTOS.mel), organic: true, harvestedAt: "2026-08-28", soldTotal: 14 },
  { id: "p_polpa", producerId: "prod_docesdaroca", categoryId: "processados", name: "Polpa de Fruta Congelada", description: "Pacote 1kg — maracujá, manga ou acerola. Engradado com múltiplas unidades.", pricePerUnit: 96, unit: "engradado", availableQty: 10, imageSeed: img("🧊", "#8a3e6b", "#c97fa8", FOOD_PHOTOS.polpa), organic: false, harvestedAt: "2026-09-10", soldTotal: 13 },
  ...
  { id: "p_alface_vistaalegre", producerId: "prod_vistaalegre", categoryId: "verduras", name: "Alface Crespa", description: "Colhida em mutirão, embalada em maços de 3 unidades. Venda em caixa de atacado.", pricePerUnit: 59, unit: "cx", availableQty: 13, imageSeed: img("🥬", "#2f6b3f", "#8fc94a", FOOD_PHOTOS.alface), organic: false, harvestedAt: "2026-09-16", soldTotal: 35 },
  { id: "p_alface_hortadaserra", producerId: "prod_hortadaserra", categoryId: "verduras", name: "Alface Crespa", description: "Cultivo de altitude na serra, folhas bem crocantes. Venda em caixa de atacado.", pricePerUnit: 73, unit: "cx", availableQty: 6, imageSeed: img("🥬", "#1a4d32", "#5c9c6b", FOOD_PHOTOS.alface), organic: true, harvestedAt: "2026-09-17", soldTotal: 6 },
  { id: "p_alface_raizesdovale", producerId: "prod_raizesdovale", categoryId: "verduras", name: "Alface Crespa", description: "Parceria com horta comunitária, preço popular. Venda em caixa de atacado.", pricePerUnit: 55, unit: "cx", availableQty: 8, imageSeed: img("🥬", "#8a5a34", "#c98f56", FOOD_PHOTOS.alface), organic: false, harvestedAt: "2026-09-15", soldTotal: 14 },
  { id: "p_alface_cantodogalo", producerId: "prod_cantodogalo", categoryId: "verduras", name: "Alface Crespa", description: "Horta ao lado do galinheiro, adubo 100% natural. Venda em caixa de atacado.", pricePerUnit: 67, unit: "cx", availableQty: 6, imageSeed: img("🥬", "#e0b84a", "#f7e29b", FOOD_PHOTOS.alface), organic: true, harvestedAt: "2026-09-16", soldTotal: 9 },

  // Tomate Salada também na Boa Esperança
  { id: "p_tomate_boaesperanca", producerId: "prod_boaesperanca", categoryId: "legumes", name: "Tomate Salada", description: "Estufa própria, colheita duas vezes por semana. Venda em caixa de atacado.", pricePerUnit: 151, unit: "cx", availableQty: 8, imageSeed: img("🍅", "#c93a4e", "#f2708a", FOOD_PHOTOS.tomate), organic: true, harvestedAt: "2026-09-15", soldTotal: 18 },

  // Couve Manteiga também na Horta da Serra
  { id: "p_couve_hortadaserra", producerId: "prod_hortadaserra", categoryId: "verduras", name: "Couve Manteiga", description: "Maços pequenos, ideais pra quem mora sozinho. Venda em caixa de atacado.", pricePerUnit: 63, unit: "cx", availableQty: 6, imageSeed: img("🥬", "#1a4d32", "#5c9c6b", FOOD_PHOTOS.couve), organic: true, harvestedAt: "2026-09-17", soldTotal: 5 },

  // Rúcula também na Horta da Serra
  { id: "p_rucula_hortadaserra", producerId: "prod_hortadaserra", categoryId: "verduras", name: "Rúcula", description: "Sabor mais suave, cultivo de altitude. Venda em caixa de atacado.", pricePerUnit: 95, unit: "cx", availableQty: 6, imageSeed: img("🌱", "#2f6b3f", "#8fc94a", FOOD_PHOTOS.rucula), organic: true, harvestedAt: "2026-09-17", soldTotal: 3 },

  // Cenoura também na Vista Alegre
  { id: "p_cenoura_vistaalegre", producerId: "prod_vistaalegre", categoryId: "raizes", name: "Cenoura", description: "Lavada e selecionada, embalagem de 1kg. Saco padrão de atacado (25–60 kg).", pricePerUnit: 143, unit: "saco", availableQty: 4, imageSeed: img("🥕", "#d9762b", "#f2b134", FOOD_PHOTOS.cenoura), organic: false, harvestedAt: "2026-09-14", soldTotal: 20 },

  // Banana Prata também na Vista Alegre e Raízes do Vale
  { id: "p_banana_vistaalegre", producerId: "prod_vistaalegre", categoryId: "frutas", name: "Banana Prata", description: "Pencas médias, ponto ideal pra durar a semana. Venda em caixa de atacado.", pricePerUnit: 70, unit: "cx", availableQty: 18, imageSeed: img("🍌", "#e0b84a", "#f2b134", FOOD_PHOTOS.banana), organic: false, harvestedAt: "2026-09-16", soldTotal: 41 },
  { id: "p_banana_raizesdovale", producerId: "prod_raizesdovale", categoryId: "frutas", name: "Banana Prata", description: "Cultivo consorciado com mandioca, sabor intenso. Venda em caixa de atacado.", pricePerUnit: 83, unit: "cx", availableQty: 7, imageSeed: img("🍌", "#8a5a34", "#c98f56", FOOD_PHOTOS.banana), organic: true, harvestedAt: "2026-09-13", soldTotal: 12 },

  // Mandioca também na Vista Alegre
  { id: "p_mandioca_vistaalegre", producerId: "prod_vistaalegre", categoryId: "raizes", name: "Mandioca Descascada", description: "Direto da roça coletiva, embalada a vácuo. Saco padrão de atacado (25–60 kg).", pricePerUnit: 152, unit: "saco", availableQty: 3, imageSeed: img("🍠", "#8a5a34", "#c98f56", FOOD_PHOTOS.mandioca), organic: false, harvestedAt: "2026-09-13", soldTotal: 10 },

  // Ovos Caipira também na Vista Alegre e Grãos do Cerrado
  { id: "p_ovos_vistaalegre", producerId: "prod_vistaalegre", categoryId: "laticinios", name: "Ovos Caipira", description: "Dúzia, produção da cooperativa. Venda em caixa de atacado.", pricePerUnit: 364, unit: "cx", availableQty: 6, imageSeed: img("🥚", "#e0b84a", "#f7e29b", FOOD_PHOTOS.ovos), organic: false, harvestedAt: "2026-09-16", soldTotal: 15 },
  { id: "p_ovos_graoscerrado", producerId: "prod_graoscerrado", categoryId: "laticinios", name: "Ovos Caipira", description: "Galinhas criadas soltas no meio da lavoura. Venda em caixa de atacado.", pricePerUnit: 434, unit: "cx", availableQty: 6, imageSeed: img("🥚", "#b8892b", "#e8c565", FOOD_PHOTOS.ovos), organic: true, harvestedAt: "2026-09-17", soldTotal: 4 },

  // Limão Taiti também na Vista Alegre
  { id: "p_limao_vistaalegre", producerId: "prod_vistaalegre", categoryId: "frutas", name: "Limão Taiti", description: "Pomar consorciado, casca fina. Venda em caixa de atacado.", pricePerUnit: 77, unit: "cx", availableQty: 8, imageSeed: img("🍋", "#8fc94a", "#d3f08a", FOOD_PHOTOS.limao), organic: false, harvestedAt: "2026-09-15", soldTotal: 13 },
];
